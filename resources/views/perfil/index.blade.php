    ...
    <div class="md:flex md:justify-center">
        <div class="md:w-1/2 bg-white shadow p-6">
          ...
          <div class="mb-5">
              ...
              <input type="password" id="current_password" name="current_password" placeholder="Tu Contraseña Actual" class="border p-3 w-full rounded-lg
          ...
          <div class="mb-5">
              <label for="new_password_confirmation" id="new_password_confirmation" class="mb-2 uppercase text-gray-500 font-bold">
                  Confirmar Nueva Contraseña
              </label>
              <input type="password" id="new_password_confirmation" name="new_password_confirmation" placeholder="Confirma tu Nueva Contraseña"
                     class="border p-3 w-full rounded-lg
